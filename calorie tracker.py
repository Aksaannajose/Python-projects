...
while not done:
    ...
    if choice =="1":
        ...
        axs[0, 0].pie([protein_sum, fats_sum, carbs_sum], labels=["Protein", "Fat", "Carbs"], autopct="%1.1f%%")
        axs[0, 0].set_title("Micronutrients Distribution")
        ...
        axs[0, 1].set_title("Micronutrients Progress")
        ...
        axs[1, 1].legend()
        axs[1, 1].set_title("Clories Goal Over Time")
        fig.tight_layout()
        plt.show()
    elif choice == "q":
        done = True
